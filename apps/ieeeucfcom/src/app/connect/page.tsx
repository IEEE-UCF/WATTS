...
export default function ConnectPage() { 
            ...
            <div className="flex display flex-col">
                ...
                <div className="justify-between items-start text-left py-30 p-15 bg-[#30250a] flex flex-row -translate-y-20">
                    ...
                    <div className="flex flex-col display gap-y-3 self-center">
                        ...
                        <Link href={"https://www.instagram.com/ieeeucf/?hl=en"} className="w-full flex display flex-row font-bold text-white text-2xl items-center gap-x-5 font-['Open Sans'] hover:text-[var(--ieee-bright-yellow)] transition-colors">
                        ...
                        <Link href={"https://www.youtube.com/@ieeeucf2287"} className="w-full flex display flex-row font-bold text-white text-2xl items-center gap-x-5 font-['Open Sans'] hover:text-[var(--ieee-bright-yellow)] transition-colors">
                        ...
                        <Link href={"https://www.linkedin.com/company/ieee-ucf/"} className="w-full flex display flex-row font-bold text-white text-2xl items-center gap-x-5 font-['Open Sans'] hover:text-[var(--ieee-bright-yellow)] transition-colors">
                        ...
                        <Link href={"https://www.facebook.com/ieeeatucf/"} className="w-full flex display flex-row font-bold text-white text-2xl items-center gap-x-5 font-['Open Sans'] hover:text-[var(--ieee-bright-yellow)] transition-colors">
  ...
  <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27s1.36.09 2 .27c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8"/>
                    ...
                    <Image
                        className="h-100 lg:block hidden w-150 object-cover rounded-sm hover:scale-101 transition-transform"
                ...
                Head over to <Link href={"https://www.ieee.org"}>IEEE.org</Link> and select <span className="font-[subheading-italic-font] text-white">Join IEEE</span>.
                        ...
                        <Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit hover:scale-102 transition-transform rounded-sm bg-[var(--ieee-dark-grey)] border-white border-1 opacity-90 hover:opacity-100">
                            <CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
                                ...
                                <div className="font-[body-font] text-white">
                To create an account, select <span className="font-[subheading-italic-font] text-white">JOIN AS A STUDENT</span>.
            </div>
                                <Image 
                                    className="object-center object-cover w-full h-auto rounded-sm" 
                        ...
                        <Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit hover:scale-102 transition-transform rounded-sm bg-[var(--ieee-dark-grey)] border-white border-1 opacity-90 hover:opacity-100">
                            <CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
                                ...
                                <div className="font-[body-font] text-white">
                Fill out the following fields. <span className="font-[subheading-italic-font] text-[var(--ieee-bright-yellow)]">Use your UCF email, not personal email!</span>
            </div>
                                <Image 
                                    className="object-center object-cover w-full h-auto rounded-sm" 
                        ...
                        <Card className="lg:w-1/4 2xl:h-fit lg:h-100 w-full h-fit hover:scale-102 transition-transform rounded-sm bg-[var(--ieee-dark-grey)] border-white border-1 opacity-90 hover:opacity-100">
                            <CardContent className="flex w-full justify-start flex-col items-start text-left gap-y-1 flex-wrap">
                                ...
                                <div className="font-[body-font] text-white">
                Accept the Terms and Conditions, fill out payment information, and check email to confirm.
            </div>
                                <Image 
                                    className="object-center object-cover w-full h-auto rounded-sm" 
                                    src="/newmembers/stepthree.png"
