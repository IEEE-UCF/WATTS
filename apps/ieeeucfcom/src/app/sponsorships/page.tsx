	...
	return (
		<div className="flex flex-col max-w-screen overflow-hidden bg-black">
			...
			<div className="p-10 bg-black m-10 rounded-xl">
				<iframe
					src="/IEEE-UCF-Sponsorship-Packet-2025-2026.pdf"
					width="100%"
					height="700px"
				/>
				...
				<a
					href="/IEEE-UCF-Sponsorship-Packet-2025-2026.pdf"
					download="IEEE-UCF-Sponsorship-Packet-2025-2026.pdf"
					className="text-white flex flex-row align-middle place-self-center lg:place-self-start items-center gap-x-5 lg:gap-x-10"
				>
					<div className="relative group cursor-pointer">
						<div className="absolute -inset-1 bg-gradient-to-r from-[var(--ieee-bright-yellow)] to-[var(--ieee-bright-yellow)] rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
						...
						<div className="relative px-7 py-3 bg-[#0c0a09] ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
							<div className="space-y-2">
								<button className="text-white font-bold text-sm flex-wrap">
									DOWNLOAD
								</button>
							</div>
						</div>
						...
						<div className="relative px-7 py-3 bg-[#0c0a09] ring-1 ring-gray-900/5 rounded-lg leading-none flex items-top justify-start space-x-6">
							<div className="space-y-2">
								<a
									href="/IEEE-UCF-Sponsorship-Packet-2025-2026.pdf"
									target="_blank"
									className="font-bold text-white text-sm flex-wrap"
								>
									OPEN IN NEW TAB
								</a>
							</div>
