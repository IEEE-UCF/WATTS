...
export default function RegisterPage() {
  ...
  // basically, redirect to / if they gucci
  ...
  // check if session is good to go
  useEffect(() => {
  ...
  return (
    <div className="flex justify-center min-h-screen items-center bg-black">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col relative z-10 h-1/2  w-full">
                ...
                <div className="flex justify-center items-center">
                  <div className="relative group cursor-pointer">
                    ...
                    <Button
                      ...
                      className="relative z-10 flex items-center justify-center gap-2 px-14 py-5 font-[heading-font] rounded-md text-white bg-black border-none hover:scale-105 transition-transform hover:cursor-pointer"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
