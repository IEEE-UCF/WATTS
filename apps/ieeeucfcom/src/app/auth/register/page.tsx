		...
		<div className="flex min-h-screen items-center justify-center bg-ieee-dark-grey">
			<div className="relative w-full max-w-lg justify-center rounded-lg border bg-black p-5 shadow-lg sm:h-[90vh] lg:m-10">
				...
				<div className="relative z-10 max-h-full overflow-y-auto">
					<form onSubmit={handleSubmit} className="relative z-10 flex h-1/2 flex-col">
						<FieldGroup className="flex h-1/2 place-content-center items-center justify-center text-white">
							<FieldSet>
								<div className="mb-4 flex justify-center">
									<h1 className="font-heading text-4xl text-white">IEEE @ UCF</h1>
								</div>
								<div className="mb-6 flex justify-center">
									<h2 className="font-body-italic text-xl text-white">
								...
								{!session?.user ? (
									<div className="flex flex-col items-center justify-center">
										<div className="group relative cursor-pointer">
											...
											<Button
												...
												className="relative z-10 flex items-center justify-center gap-2 rounded-md border-none bg-ieee-dark-yellow px-14 py-10 font-heading text-white transition-transform hover:scale-105 hover:cursor-pointer"
											>
												<svg
													className="h-5 w-5"
													fill="currentColor"
									...
									<>
										...
										<FieldGroup className="space-y-4">
											...
											<div className="pt-4">
												<h3 className="mb-3 text-sm font-medium underline underline-offset-4">
													Date of Birth
												</h3>
