...
const demoEventData: DemoEventData = {
	...
	description:
		'This is a test event created via the /api/events/demo route for database insertion testing.',
	flyerUrl: null,
	rsvpLink: null,
						...
						<form onSubmit={handleSubmit}>
							...
							<div className="flex justify-end">
								<button
									...
									className="bg-indigo-600 text-white px-4 py-2 rounded-md mr-30"
								>
									Load Demo Data
								</button>
								<button
