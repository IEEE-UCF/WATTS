		...
		<div className="group relative self-center">
			...
			<div className="relative flex flex-col items-center space-y-6 rounded-sm bg-ieee-near-black px-10 py-12 text-center leading-none ring-1 ring-gray-900/5">
				...
				<button
					...
					className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-yellow-500 px-6 py-3 font-heading text-white transition duration-300 hover:scale-102"
				>
				...
				<span className="flex flex-row items-center gap-2">
					<div className="font-subheading text-base text-white">
						Don&apos;t have an account?
					</div>
					<a
						className="font-heading text-lg text-white transition-all hover:scale-102 hover:text-ieee-dark-yellow"
						href="/auth/register"
					>
						REGISTER
					</a>
