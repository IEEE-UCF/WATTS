...
export default function AboutHeader() {
	...
	return (
		<div className="">
			<div className="animated-background absolute inset-0 top-0 left-0 z-2 h-full w-full items-center justify-center place-self-center bg-gradient-to-r px-5 [background:radial-gradient(300%_125%_at_30%_0%,var(--color-ieee-near-black)_10%,transparent_100%)]"></div>
				...
				<div className="float flex flex-col items-center justify-center gap-y-3 self-center text-center">
					...
					<div className="group relative max-w-screen cursor-pointer">
						...
						<div className="group relative w-fit cursor-pointer overflow-hidden rounded-2xl bg-transparent p-[4px] transition-transform hover:scale-102">
							...
							<button
								className="relative z-10 h-[280px] w-85 max-w-screen cursor-pointer items-center justify-center rounded-2xl bg-ieee-near-black p-5 text-white backdrop-blur-sm sm:w-120 md:h-[235px] md:w-170 lg:w-195"
