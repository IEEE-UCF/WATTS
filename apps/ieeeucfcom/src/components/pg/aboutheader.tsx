...
export default function AboutHeader() {
	...
	return (
		<div className="">
			<div className="absolute inset-0 top-0 left-0 z-2 h-full w-full animated-background items-center justify-center place-self-center bg-gradient-to-r px-5 [background:radial-gradient(300%_125%_at_30%_0%,#0c0a09_10%,transparent_100%)]"></div>

			<div className="absolute z-3 my-10 flex w-screen flex-row justify-center p-40">
				<div className="flex float flex-col items-center justify-center gap-y-3 self-center text-center">
					...
					<div className="group relative max-w-screen cursor-pointer">
						...
						<div className="group relative w-fit cursor-pointer overflow-hidden rounded-2xl bg-transparent p-[4px] transition-transform hover:scale-102">
							<div className="pointer-events-none absolute inset-0 z-0 animated-border rounded-2xl bg-[conic-gradient(var(--ieee-bright-yellow)_20deg,transparent_120deg)]"></div>
