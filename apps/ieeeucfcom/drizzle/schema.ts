import { pgTable, index, foreignKey, unique, uuid, varchar, text, timestamp, boolean, date, integer, pgEnum } from "drizzle-orm/pg-core"
import { sql } from "drizzle-orm"

export const genderEnum = pgEnum("gender_enum", ['M', 'F', 'NB', 'O', 'PNTS'])
export const officerRoleEnum = pgEnum("officer_role_enum", ['Executive Chair', 'Vice Chair', 'Treasurer', 'Secretary', 'Project Chair', 'Workshop Chair', 'Conference Chair', 'Outreach Chair', 'Service Chair', 'Social Chair', 'Professional Development Chair', 'Marketing Chair', 'Software Chair'])
...
export const committees = pgTable("committees", {
	...
	index("committees_idx_chair_id").using("btree", table.chairId.asc().nullsLast().op("uuid_ops")),
	index("committees_idx_created_at").using("btree", table.createdAt.asc().nullsLast().op("timestamptz_ops")),
	...
	index("committees_idx_updated_at").using("btree", table.updatedAt.asc().nullsLast().op("timestamptz_ops")),
	foreignKey({
...
export const committeeMembers = pgTable("committee_members", {
	...
	index("committee_members_idx_committee_id").using("btree", table.committeeId.asc().nullsLast().op("uuid_ops")),
	index("committee_members_idx_id").using("btree", table.id.asc().nullsLast().op("uuid_ops")),
	index("committee_members_idx_is_chair").using("btree", table.isChair.asc().nullsLast().op("bool_ops")),
	index("committee_members_idx_member_id").using("btree", table.memberId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const projectMembers = pgTable("project_members", {
	...
	index("project_members_idx_is_lead").using("btree", table.isLead.asc().nullsLast().op("bool_ops")),
	index("project_members_idx_member_id").using("btree", table.memberId.asc().nullsLast().op("uuid_ops")),
	index("project_members_idx_project_id").using("btree", table.projectId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const members = pgTable("members", {
	...
	index("members_idx_active_officer").using("btree", table.officerStatus.asc().nullsLast().op("bool_ops"), table.administrator.asc().nullsLast().op("bool_ops")),
	index("members_idx_administrator").using("btree", table.administrator.asc().nullsLast().op("bool_ops")),
	index("members_idx_created_at").using("btree", table.createdAt.asc().nullsLast().op("timestamptz_ops")),
	index("members_idx_discordId").using("btree", table.discordId.asc().nullsLast().op("text_ops")),
	index("members_idx_dues_paid").using("btree", table.duesPaid.asc().nullsLast().op("bool_ops")),
	index("members_idx_full_name").using("btree", table.firstName.asc().nullsLast().op("text_ops"), table.lastName.asc().nullsLast().op("text_ops")),
	index("members_idx_gender").using("btree", table.gender.asc().nullsLast().op("enum_ops")),
	index("members_idx_graduation_year").using("btree", table.graduationYear.asc().nullsLast().op("int4_ops")),
	...
	index("members_idx_officer_role").using("btree", table.officerRole.asc().nullsLast().op("enum_ops")),
	index("members_idx_officer_status").using("btree", table.officerStatus.asc().nullsLast().op("bool_ops")),
	index("members_idx_personal_email").using("btree", table.personalEmail.asc().nullsLast().op("text_ops")),
	index("members_idx_ucf_email").using("btree", table.ucfEmail.asc().nullsLast().op("text_ops")),
	index("members_idx_updated_at").using("btree", table.updatedAt.asc().nullsLast().op("timestamptz_ops")),
	foreignKey({
...
export const projects = pgTable("projects", {
	...
	index("projects_idx_created_at").using("btree", table.createdAt.asc().nullsLast().op("timestamptz_ops")),
	...
	index("projects_idx_updated_at").using("btree", table.updatedAt.asc().nullsLast().op("timestamptz_ops")),
...
export const eventAttendees = pgTable("event_attendees", {
	...
	index("event_attendees_idx_event_id").using("btree", table.eventId.asc().nullsLast().op("uuid_ops")),
	index("event_attendees_idx_id").using("btree", table.id.asc().nullsLast().op("uuid_ops")),
	index("event_attendees_idx_member_id").using("btree", table.memberId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const sponsorships = pgTable("sponsorships", {
	...
	index("sponsorships_idx_company_name").using("btree", table.companyName.asc().nullsLast().op("text_ops")),
	index("sponsorships_idx_created_at").using("btree", table.createdAt.asc().nullsLast().op("timestamptz_ops")),
	...
	index("sponsorships_idx_updated_at").using("btree", table.updatedAt.asc().nullsLast().op("timestamptz_ops")),
]);
